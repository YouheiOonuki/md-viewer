...
const INLINE = ["md-viewer.html"];
const INLINE_SRC = "src/reset-storage.js";
const ROOT = path.join(__dirname, "..");
const SKIP_DIRS = new Set(['node_modules', 'tests', 'test', '.git', '.github', 'tools', "src"]);
